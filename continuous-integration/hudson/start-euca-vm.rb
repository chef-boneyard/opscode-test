...
if wait_for_ssh_running(instance, use_private_ip)
  do_on_remote(instance, use_private_ip, "'sudo hostname ubuntu-ci-slave-euca && sudo chef-client -l debug && /srv/opscode-test/current/continuous-integration/hudson/start-hudson-slave.sh'")
else
